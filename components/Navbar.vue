<template>
  <div class="relative px-4 sm:px-24 top-6">
    <nav class="bg-white rounded-full shadow min-w-full">
      <div class="flex justify-between h-16 px-8 sm:px-8">
        ...
        <div class="sm:hidden flex items-center">
          ...
          >
            <nuxt-icon name="menu" class="text-3xl" />
          </button>
        </div>
        ...
        <div class="hidden sm:flex sm:items-center sm:space-x-8">
          ...
          <div v-else class="flex items-center">
            ...
            <button @click="navigateTo({ name: 'notification' })">
      ...
      <div v-if="isMobileMenuOpen" class="sm:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1">
          <nuxt-link
            :to="{ name: 'facilitators' }"
            class="block px-3 py-2 rounded-md text-base font-medium text-gray-900 hover:bg-gray-100 focus:outline-none focus:bg-gray-100 transition duration-150 ease-in-out"
          >
            Facilitators List
          </nuxt-link>
