import { inject, provide, ref, computed, cloneVNode, h as h$1, Fragment, defineComponent, watchEffect } from 'vue';
...
function o$2() {
  let a = [], s3 = { addEventListener(e, t2, r, i2) {
    return e.addEventListener(t2, r, i2), s3.add(() => e.removeEventListener(t2, r, i2));
...
let t$3 = Symbol("headlessui.useid"), i$4 = 0;
function I$1() {
  return inject(t$3, () => `${++i$4}`)();
}
function l$1(e) {
  provide(t$3, e);
}
...
function w$2(e, r = 0) {
  var t2;
  return e === ((t2 = i$2(e)) == null ? void 0 : t2.body) ? false : u$2(r, { [0]() {
    return e.matches(c);
  }, [1]() {
    let l2 = e;
    for (; l2 !== null; ) {
...
function w(f2, m, l2 = computed(() => true)) {
  ...
  u$1("pointerdown", (e) => {
    var r, t2;
    l2.value && (u2.value = ((t2 = (r = e.composedPath) == null ? void 0 : r.call(e)) == null ? void 0 : t2[0]) || e.target);
...
export { A, E, I$1 as I, N, O, P, S$1 as S, T, u$2 as a, o as b, T$1 as c, N$1 as d, w$2 as e, f, t$1 as g, h, i$2 as i, i as j, l as k, l$1 as l, S as m, c$1 as n, o$1 as o, w$1 as p, t as q, o$2 as r, s2 as s, t$4 as t, u, t$2 as v, w, n$1 as x };
//# sourceMappingURL=active-element-history-BR_of3CF.mjs.map
