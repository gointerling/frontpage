...
import { ref, computed, onMounted, watchEffect, defineComponent, watch, provide, h, cloneVNode, reactive, toRaw, Fragment, inject, onUnmounted, nextTick, toRef, useSSRContext, resolveComponent, mergeProps, withCtx, renderSlot, createVNode, openBlock, createBlock, createCommentVNode, toDisplayString, renderList, createTextVNode, Transition } from 'vue';
import { useVirtualizer } from '@tanstack/vue-virtual';
import { o as o$1, a as u$2, w, g as t$1, j as i$2, f as f$2, E, u as u$3, A, T, I as I$1, i as i$2$1, N, k as l, l as l$1, O, b as o$2, r as o$2$1, q as t$2, x as n$1 } from './active-element-history-BR_of3CF.mjs';
...
let ie = Symbol("VirtualContext"), Ae = defineComponent({ name: "VirtualProvider", setup(a, { slots: h$1 }) {
  ...
  let M = computed(() => a.multiple ? 1 : 0), $ = computed(() => a.nullable), [B, p] = d(computed(() => a.modelValue), (t2) => y("update:modelValue", t2), computed(() => a.defaultValue)), R = computed(() => B.value === void 0 ? u$2(M.value, { [1]: [], [0]: void 0 }) : B.value), V = null, i2 = null;
  function I2(t2) {
...
let nt = defineComponent({ name: "ComboboxButton", props: { as: { type: [Object, String], default: "button" }, id: { type: String, default: null } }, setup(a, { attrs: h2, slots: r2, expose: y }) {
  ...
  var V;
  let u2 = (V = a.id) != null ? V : `headlessui-combobox-input-${I$1()}`, e2 = K("ComboboxInput"), c$1 = computed(() => i$2$1(o$1(e2.inputRef))), f2 = { value: false };
  ...
  function p(i2) {
    var T2, l2, g2;
    let I2 = (T2 = i2.relatedTarget) != null ? T2 : t$2.find((t2) => t2 !== i2.currentTarget);
    (l2 = o$1(e2.buttonRef)) != null && l2.contains(I2) || (g2 = o$1(e2.optionsRef)) != null && g2.contains(I2) || e2.disabled.value || e2.immediate.value && e2.comboboxState.value !== 0 && (e2.openCombobox(), o$2$1().nextFrame(() => {
...
export { __nuxt_component_10 as _, u$1 as a, ut as b, c, d, e, f$1 as f, it as i, lt as l, nt as n, rt as r, s, usePopper as u };
//# sourceMappingURL=InputMenu-JB5AMlSu.mjs.map
