          ...
          if (_push2) {
            _push2(ssrRenderComponent(_component_UCard, { ui: {
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  _push3(`<div class="flex flex-col justify-center items-center"${_scopeId2}><h3 class="text-lg font-semibold"${_scopeId2}>${ssrInterpolate(__props.data.title)}</h3><div class="p-4"${_scopeId2}><p${_scopeId2}>${ssrInterpolate(__props.data.content)}</p></div><div class="flex justify-end space-x-2 p-4"${_scopeId2}><button class="px-4 py-2 bg-gray-200 text-gray-700 rounded hover:bg-gray-300"${_scopeId2}>${ssrInterpolate(__props.data.cancelText)}</button><button class="px-4 py-2 bg-blue-600 text-white rounded hover:bg-blue-700"${_scopeId2}>${ssrInterpolate(__props.data.confirmText)}</button></div></div>`);
                } else {
                  return [
                    createVNode("div", { class: "flex flex-col justify-center items-center" }, [
                      ...
                      createVNode("div", { class: "p-4" }, [
                        createVNode("p", null, toDisplayString(__props.data.content), 1)
                      ]),
                      createVNode("div", { class: "flex justify-end space-x-2 p-4" }, [
                        createVNode("button", {
                          onClick: cancel,
...
//# sourceMappingURL=ConfirmationModal-C_Y03t3C.mjs.map
