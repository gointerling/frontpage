import { m as mergeConfig, i as appConfig, j as useUI, f as useRoute, h as useCookie, e as __nuxt_component_2, _ as _export_sfc } from './server.mjs';
import { defineComponent, ref, h, computed, provide, onMounted, watch, watchEffect, Fragment, onUnmounted, inject, toRef, useSSRContext, unref, mergeProps, withCtx, createVNode, toDisplayString, openBlock, createBlock, renderList, resolveComponent, renderSlot, createTextVNode, createCommentVNode } from 'vue';
...
import { _ as _sfc_main$4 } from './Navbar-0xAJ95J7.mjs';
import { _ as _sfc_main$5 } from './Banner-BQugV_hX.mjs';
import { _ as __nuxt_component_3$1 } from './Badge-BvyqeB4k.mjs';
import _sfc_main$7 from './nuxt-icon-bR4TCIgI.mjs';
import { u as useId } from './id-TSKa-Sd6.mjs';
import { f, u, O, o as o$1, A, T, I as I$1, N, l as l$1, a as u$2, b as o, c as T$1, t as t$4, i as i$2, P, d as N$1 } from './active-element-history-BR_of3CF.mjs';
import { s } from './InputMenu-JB5AMlSu.mjs';
import { useResizeObserver } from '@vueuse/core';
import { _ as __nuxt_component_2$1 } from './Card-4tUwX30q.mjs';
import { _ as _sfc_main$6 } from './OrderSidebar-BM64jKt3.mjs';
import '../runtime.mjs';
import 'node:http';
import 'node:https';
import 'fs';
...
let G = Symbol("TabsSSRContext"), me = defineComponent({ name: "TabGroup", emits: { change: (a) => true }, props: { as: { type: [Object, String], default: "template" }, selectedIndex: { type: [Number], default: null }, defaultIndex: { type: [Number], default: 0 }, vertical: { type: [Boolean], default: false }, manual: { type: [Boolean], default: false } }, inheritAttrs: false, setup(a, { slots: b, attrs: s2, emit: d$1 }) {
  ...
  function y(t2) {
    ...
    if (t2 < 0 || t2 > n.length - 1) {
      let I2 = u$2(i2.value === null ? 0 : Math.sign(t2 - i2.value), { [-1]: () => 1, [0]: () => u$2(Math.sign(t2), { [-1]: () => 0, [0]: () => 0, [1]: () => 1 }), [1]: () => 0 }), m = u$2(I2, { [0]: () => n.indexOf(e[0]), [1]: () => n.indexOf(e[e.length - 1]) });
  ...
  function T2(e) {
    ...
    if (c === T$1.Success && l2.activation.value === "auto") {
      let m = (I2 = i$2(r)) == null ? void 0 : I2.activeElement, h2 = l2.tabs.value.findIndex((O2) => o$1(O2) === m);
  ...
  function x(e) {
    ...
    if (T2(() => u$2(l2.orientation.value, { vertical() {
  ...
  function E() {
    var e;
    w.value || (w.value = true, !a.disabled && ((e = o$1(r)) == null || e.focus({ preventScroll: true }), l2.setSelectedIndex(y.value), t$4(() => {
      w.value = false;
    })));
  }
  function t$1(e) {
  ...
  return () => {
    var m, h2;
    let e = { selected: u2.value, disabled: (m = a.disabled) != null ? m : false }, { ...c } = a, I2 = { ref: r, onKeydown: x, onMousedown: t$1, onClick: E, id: i$1, role: "tab", type: n.value, "aria-controls": (h2 = o$1(l2.panels.value[y.value])) == null ? void 0 : h2.id, "aria-selected": u2.value, tabIndex: u2.value ? 0 : -1, disabled: a.disabled ? true : void 0 };
...
const _sfc_main$2 = {
  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      const _component_nuxt_icon = _sfc_main$7;
      const _component_UTabs = __nuxt_component_3;
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "bg-[#D7EEF8] rounded-3xl shadow-lg pt-8 flex flex-col items-center" }, _attrs))}>`);
      _push(ssrRenderComponent(_component_UAvatar, {
        alt: __props.data.users[0].fullname,
        src: __props.data.users[0].photo,
      ...
      _push(`<h2 class="text-xl text-primary font-bold pt-3 pb-1">${ssrInterpolate(__props.data.users[0].fullname)}</h2>`);
      _push(ssrRenderComponent(_component_UBadge, {
        color: "orange",
        label: __props.data.type,
        variant: "soft",
        class: "uppercase my-2"
      }, null, _parent));
      _push(`<div class="flex gap-2 pt-2 pb-6"><div class="flex gap-2 items-center px-2">`);
      _push(ssrRenderComponent(_component_nuxt_icon, {
        name: "star",
        filled: ""
      }, null, _parent));
      _push(`<span class="font-bold text-primary">${ssrInterpolate(__props.data.rating)}</span></div><div class="w-[2px] h-100 rounded bg-primary"></div><div class="flex gap-2 items-center px-2">`);
      _push(ssrRenderComponent(_component_nuxt_icon, {
        name: "love",
        filled: ""
      }, null, _parent));
      _push(`<span class="font-bold text-primary">${ssrInterpolate(__props.data.recomended_count)}</span></div></div>`);
      _push(ssrRenderComponent(_component_UTabs, {
        items: unref(serviceItems),
...
const _sfc_main$1 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      ssrRenderList(checkIfJSON(__props.data.users[0].main_skills), (skill) => {
        _push(ssrRenderComponent(_component_UBadge, {
          label: skill.name,
          key: skill,
      ...
      _push(`<!--]--></div></div><h6 class="text-primary font-bold text-xl">About</h6><div class="flex gap-2 py-4"><p class="text-primary text-md">${ssrInterpolate(__props.data.users[0].personal_description)}</p></div><h6 class="text-primary font-bold text-xl">Certificate</h6><div class="flex gap-2 py-4"><!--[-->`);
      ssrRenderList(checkIfJSON(__props.data.certificates), (certificate, index) => {
        _push(ssrRenderComponent(_component_UCard, {
          ...
          onClick: ($event) => openNewTab(certificate)
        }, {
          default: withCtx((_, _push2, _parent2, _scopeId) => {
            if (_push2) {
              ...
              _push2(`<span class="text-primary"${_scopeId}>Certificate ${ssrInterpolate(index + 1)}</span></div>`);
            } else {
              return [
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (isPageLoading.value) {
        ...
        _push(ssrRenderComponent(_sfc_main$2, {
          data: merchant.value,
          onOrder: ($event) => isOrderSidebarOpen.value = true
        }, null, _parent));
        _push(`</div><div class="col-span-9">`);
        _push(ssrRenderComponent(_sfc_main$1, { data: merchant.value }, null, _parent));
        _push(`</div></div></div></div>`);
      }
      _push(ssrRenderComponent(_sfc_main$6, {
        isOpen: isOrderSidebarOpen.value,
        data: unref(selectedMerchant),
...
//# sourceMappingURL=_id_-CLB3Nnnq.mjs.map
