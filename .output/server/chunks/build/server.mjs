...
const _routes = [
  {
    ...
    alias: [],
    redirect: void 0 ,
    component: () => import('./index-BEbZs86K.mjs').then((m) => m.default || m)
  }
];
...
const LazyNuxtIcon = defineAsyncComponent(() => import('./nuxt-icon-D-8m2hDi.mjs').then((r) => r["default"] || r.default || r));
