import { b as useToast, k as useRouter, c as __nuxt_component_0$4, d as __nuxt_component_0$1, e as __nuxt_component_2$1 } from './server.mjs';
...
import { ref, watch, withCtx, unref, createTextVNode, createVNode, toDisplayString, openBlock, createBlock, Fragment, renderList, createCommentVNode, useSSRContext } from 'vue';
              ...
              default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                if (_push3) {
                  ...
                  _push3(ssrRenderComponent(_component_UButton, {
                    size: "sm",
                    color: "primary",
                    onClick: ($event) => navigateTo({ name: "my-merchant-services-add" })
                  }, {
...
_sfc_main.setup = (props, ctx) => {
  ...
  (ssrContext.modules || (ssrContext.modules = /* @__PURE__ */ new Set())).add("pages/my/merchant/services/index.vue");
  return _sfc_setup ? _sfc_setup(props, ctx) : void 0;
};

export { _sfc_main as default };
//# sourceMappingURL=index-pA21qEic.mjs.map
