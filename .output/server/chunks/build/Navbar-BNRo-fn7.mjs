  ...
  setup(__props, { emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (!__props.user) {
        ...
        _push(`</button><div style="${ssrRenderStyle(unref(open) ? null : { display: "none" })}" class="absolute right-0 z-10 mt-12 w-48 py-1 bg-white rounded-lg shadow-lg">`);
        _push(ssrRenderComponent(_component_nuxt_link, {
          href: "#",
...
//# sourceMappingURL=Navbar-BNRo-fn7.mjs.map
